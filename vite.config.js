  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        scope: '/',
        icons: [
          { src: '/icons/logo-original.png', sizes: '192x192', type: 'image/png' },
          { src: '/icons/logo-original.png', sizes: '512x512', type: 'image/png' },
          { src: '/icons/logo-original.png', sizes: '512x512', type: 'image/png', purpose: 'any maskable' },
        ],
      },
      workbox: {
